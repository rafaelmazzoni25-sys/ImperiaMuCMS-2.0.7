...
if (!isLoggedIn()) {
    ...
    if (!canAccessModule($_SESSION["username"], "clearskilltree", "block")) {
        return NULL;
    }
    $price_type = mconfig("clearst_price_type");
    if ($price_type == "1") {
    ...
    if (defined(__RESPONSIVE__) && __RESPONSIVE__ == "TRUE") {
        ...
        echo "\r\n    <h3>\r\n        " . lang("resetst_txt_8", true) . "\r\n        " . $breadcrumb . "\r\n    </h3>";
        if (mconfig("active")) {
            echo "\r\n    <div class=\"row desc-row\">\r\n        <div class=\"col-xs-12\">\r\n            " . lang("resetst_txt_9", true) . "";
            if (mconfig("clearst_enable_requirement")) {
                echo "<br />" . sprintf(lang("resetst_txt_10", true), number_format(mconfig("clearst_price")), $price_type);
            }
            echo "\r\n        </div>\r\n    </div>";
            ...
            if (is_array($AccountCharacters)) {
                if (check_value($_POST["submit"])) {
                    if ($_SESSION["token"] == $_POST["token"]) {
                        if ($common->beginDbTrans($_SESSION["username"])) {
                            $Character->CharacterResetSkillTree($_SESSION["username"], $_POST["character"], $_SESSION["userid"]);
                ...
                echo "\r\n    <div class=\"row\">\r\n        <div class=\"col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4 col-center\">\r\n            <form action=\"\" method=\"post\">\r\n                <div class=\"form-group\">\r\n                    <label>" . lang("resetst_txt_11", true) . "</label>\r\n                    <select name=\"character\" class=\"form-control\">\r\n                        " . $charOpts . "\r\n                    </select>\r\n                </div>\r\n                <div class=\"form-group\">\r\n                    " . lang("resetst_txt_13", true) . "\r\n                </div>\r\n                <div class=\"form-group\">\r\n                    <input type=\"hidden\" name=\"token\" value=\"" . $token . "\">\r\n                    <input type=\"submit\" name=\"submit\" value=\"" . lang("resetst_txt_12", true) . "\" class=\"btn btn-warning full-width-btn\">\r\n                </div>\r\n            </form>\r\n        </div>\r\n    </div>";
            } else {
