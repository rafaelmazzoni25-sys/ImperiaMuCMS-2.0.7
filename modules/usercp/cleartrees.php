...
if (!isLoggedIn()) {
    ...
    if (!canAccessModule($_SESSION["username"], "cleartrees", "block")) {
        return NULL;
    }
    ...
    if ($General->ftanHCIfo_canUse_j8GsnawwvJ_Module("cleartrees")) {
        ...
        echo "\r\n    <div class=\"sub-page-title\">\r\n        <div id=\"title\"><h1>" . lang("module_titles_txt_3", true) . "<p></p><span></span></h1></div>\r\n    </div>\r\n    <div class=\"container_2 account\" align=\"center\">\r\n        <div class=\"cont-image\">\r\n            <div class=\"container_3 account_sub_header\">\r\n                <div class=\"grad\">\r\n                    <div class=\"page-title\">" . lang("cleartrees_txt_1", true) . "</div>\r\n                    <a href=\"" . __BASE_URL__ . "usercp\">" . lang("global_module_1", true) . "</a>\r\n                </div>\r\n            </div>\r\n            <div class=\"unstuck\">\r\n                <div class=\"page-desc-holder\">\r\n                    " . lang("cleartrees_txt_2", true);
        if (mconfig("enable_requirement")) {
            echo "<br />" . sprintf(lang("cleartrees_txt_3", true), number_format(mconfig("price")), $price_type);
        }
        echo "\r\n                </div>";
        if (mconfig("active")) {
                ...
                if (check_value($_POST["submit"])) {
                    if ($_SESSION["token"] == $_POST["token"]) {
                        if ($common->beginDbTrans($_SESSION["username"])) {
                            $Character->CharacterResetTrees($_SESSION["username"], $_POST["character"], $_SESSION["userid"]);
        ...
        message("error", lang("cleartrees_txt_7", true));
    }
}
