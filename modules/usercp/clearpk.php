...
if (!isLoggedIn()) {
    ...
    if (!canAccessModule($_SESSION["username"], "clearpk", "block")) {
        return NULL;
    }
    $price_type = mconfig("clearpk_price_type");
    if ($price_type == "1") {
    ...
    if (defined(__RESPONSIVE__) && __RESPONSIVE__ == "TRUE") {
        ...
        if (mconfig("active")) {
            ...
            if (mconfig("clearpk_enable_requirement")) {
                echo sprintf(lang("clearpk_txt_7", true), number_format(mconfig("clearpk_price")), $price_type);
            }
            echo "\r\n        </div>\r\n    </div>";
            ...
            if (is_array($AccountCharacters)) {
                ...
                echo "\r\n    <div class=\"row\">\r\n        <div class=\"col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4 col-center\">\r\n            <form action=\"\" method=\"post\">\r\n                <div class=\"form-group\">\r\n                    <label>" . lang("clearpk_txt_8", true) . "</label>\r\n                    <select name=\"character\" class=\"form-control\">\r\n                        " . $charOpts . "\r\n                    </select>\r\n                </div>\r\n                <div class=\"form-group\">\r\n                    " . lang("clearpk_txt_10", true) . "\r\n                </div>\r\n                <div class=\"form-group\">\r\n                    <input type=\"hidden\" name=\"token\" value=\"" . $token . "\">\r\n                    <input type=\"submit\" name=\"submit\" value=\"" . lang("clearpk_txt_9", true) . "\" class=\"btn btn-warning full-width-btn\">\r\n                </div>\r\n            </form>\r\n        </div>\r\n    </div>";
            } else {
        ...
        echo "\r\n\t<div class=\"sub-page-title\">\r\n\t <div id=\"title\"><h1>" . lang("module_titles_txt_3", true) . "<p></p><span></span></h1></div>\r\n  </div>\r\n  <div class=\"container_2 account\" align=\"center\">\r\n    <div class=\"cont-image\">\r\n      <div class=\"container_3 account_sub_header\">\r\n        <div class=\"grad\">\r\n          <div class=\"page-title\">" . lang("module_titles_txt_13", true) . "</div>\r\n          <a href=\"" . __BASE_URL__ . "usercp\">" . lang("global_module_1", true) . "</a>\r\n        </div>\r\n      </div>\r\n      <div class=\"unstuck\">\r\n        <div class=\"page-desc-holder\">\r\n          ";
        if (mconfig("clearpk_enable_requirement")) {
            echo "<br />" . sprintf(lang("clearpk_txt_7", true), number_format(mconfig("clearpk_price")), $price_type);
        }
        echo "</div>";
        if (mconfig("active")) {
            $Character = new Character();
