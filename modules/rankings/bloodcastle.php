...
if (defined(__RESPONSIVE__) && __RESPONSIVE__ == "TRUE") {
    ...
    if (mconfig("active")) {
        ...
        if ($showTabs) {
            ...
            $isExpanded = "true";
            $count = 0;
            if (mconfig("rankings_enable_bloodcastle")["@attributes"]["general"] == "1") {
                $count++;
            ...
            if (mconfig("rankings_enable_bloodcastle")["@attributes"]["monthly"] == "1") {
                $count++;
                if ($count == 2) {
                    $isActive = "next";
                }
            ...
            if (mconfig("rankings_enable_bloodcastle")["@attributes"]["weekly"] == "1") {
                $count++;
                if ($count == 2) {
                    $isActive = "next";
                }
            ...
            if (mconfig("rankings_enable_bloodcastle")["@attributes"]["daily"] == "1") {
                $count++;
                if ($count == 2) {
                    $isActive = "next";
                }
        ...
        if (mconfig("rankings_enable_bloodcastle")["@attributes"]["monthly"] == "1") {
            ...
            $isActive = "";
            $ranking_data = LoadCacheData("monthly_rankings/rankings_bloodcastle.cache");
            echo "\r\n        <div class=\"table-responsive rankings-table\">\r\n            <table class=\"table table-hover text-center\">\r\n                <thead>\r\n                    <tr>";
            if (mconfig("rankings_show_place_number")) {
                echo "<th>#</th>";
            }
            ...
            if (mconfig("rewards_bc")["@attributes"]["monthly"]) {
                $rewardsHtml = $Rankings->returnRewardsHtml("monthly_bloodcastle");
                if ($rewardsHtml != NULL) {
                    echo $rewardsHtml;
                }
            }
        ...
        if (mconfig("rankings_enable_bloodcastle")["@attributes"]["weekly"] == "1") {
            ...
            $isActive = "";
            $ranking_data = LoadCacheData("weekly_rankings/rankings_bloodcastle.cache");
            echo "\r\n        <div class=\"table-responsive rankings-table\">\r\n            <table class=\"table table-hover text-center\">\r\n                <thead>\r\n                    <tr>";
            if (mconfig("rankings_show_place_number")) {
                echo "<th>#</th>";
            }
            ...
            if (mconfig("rewards_bc")["@attributes"]["weekly"]) {
                $rewardsHtml = $Rankings->returnRewardsHtml("weekly_bloodcastle");
                if ($rewardsHtml != NULL) {
                    echo $rewardsHtml;
                }
            }
        ...
        if (mconfig("rankings_enable_bloodcastle")["@attributes"]["daily"] == "1") {
            ...
            $isActive = "";
            $ranking_data = LoadCacheData("daily_rankings/rankings_bloodcastle.cache");
            echo "\r\n        <div class=\"table-responsive rankings-table\">\r\n            <table class=\"table table-hover text-center\">\r\n                <thead>\r\n                    <tr>";
            if (mconfig("rankings_show_place_number")) {
                echo "<th>#</th>";
            }
            ...
            if (mconfig("rewards_bc")["@attributes"]["daily"]) {
                $rewardsHtml = $Rankings->returnRewardsHtml("daily_bloodcastle");
                if ($rewardsHtml != NULL) {
                    echo $rewardsHtml;
                }
            }
