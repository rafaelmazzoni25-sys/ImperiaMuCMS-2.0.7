...
if (defined(__RESPONSIVE__) && __RESPONSIVE__ == "TRUE") {
    ...
    if (mconfig("active")) {
        ...
        if ($showTabs) {
            ...
            $isExpanded = "true";
            $count = 0;
            if (mconfig("rankings_enable_illusiontemple")["@attributes"]["general"] == "1") {
                $count++;
            ...
            if (mconfig("rankings_enable_illusiontemple")["@attributes"]["monthly"] == "1") {
                $count++;
                if ($count == 2) {
                    $isActive = "next";
                }
            ...
            if (mconfig("rankings_enable_illusiontemple")["@attributes"]["weekly"] == "1") {
                $count++;
                if ($count == 2) {
                    $isActive = "next";
                }
            ...
            if (mconfig("rankings_enable_illusiontemple")["@attributes"]["daily"] == "1") {
                $count++;
                if ($count == 2) {
                    $isActive = "next";
                }
        ...
        if (mconfig("rankings_enable_illusiontemple")["@attributes"]["general"] == "1") {
            ...
            $isActive = "";
            $ranking_data = LoadCacheData("rankings_illusiontemple.cache");
            echo "\r\n        <div class=\"table-responsive rankings-table\">\r\n            <table class=\"table table-hover text-center\">\r\n                <thead>\r\n                    <tr>";
            if (mconfig("rankings_show_place_number")) {
                echo "<th>#</th>";
            }
            echo "\r\n                        <th>" . lang("rankings_txt_10", true) . "</th>\r\n                        <th>" . lang("rankings_txt_11", true) . "</th>\r\n                        <th>" . lang("rankings_txt_36", true) . "</th>\r\n                        <th>" . lang("rankings_txt_84", true) . "</th>\r\n                        <th>" . lang("rankings_txt_38", true) . "</th>\r\n                        <th>" . lang("rankings_txt_46", true) . "</th>";
            if ($config["flags"]) {
            ...
            foreach ($ranking_data as $rdata) {
                if (1 <= $i) {
                    ...
                    echo "<td>" . number_format($rdata[6]) . "</td>";
                    echo "<td>" . number_format($rdata[2]) . "</td>";
                    if ($config["flags"]) {
                        echo "<td><img src=\"" . __PATH_TEMPLATE__ . "images/blank.png\" class=\"flag-icon flag-icon-" . $rdata[5] . "\" alt=\"" . $custom["countries"][$rdata[5]] . "\" title=\"" . $custom["countries"][$rdata[5]] . "\" /></td>";
                    }
                    echo "</tr>";
                }
                $i++;
        ...
        if (mconfig("rankings_enable_illusiontemple")["@attributes"]["monthly"] == "1") {
            ...
            $isActive = "";
            $ranking_data = LoadCacheData("monthly_rankings/rankings_illusiontemple.cache");
            echo "\r\n        <div class=\"table-responsive rankings-table\">\r\n            <table class=\"table table-hover text-center\">\r\n                <thead>\r\n                    <tr>";
            if (mconfig("rankings_show_place_number")) {
                echo "<th>#</th>";
            }
            ...
            if (mconfig("rewards_it")["@attributes"]["monthly"]) {
                $rewardsHtml = $Rankings->returnRewardsHtml("monthly_illusiontemple");
                if ($rewardsHtml != NULL) {
                    echo $rewardsHtml;
                }
            }
        ...
        if (mconfig("rankings_enable_illusiontemple")["@attributes"]["weekly"] == "1") {
            ...
            $isActive = "";
            $ranking_data = LoadCacheData("weekly_rankings/rankings_illusiontemple.cache");
            echo "\r\n        <div class=\"table-responsive rankings-table\">\r\n            <table class=\"table table-hover text-center\">\r\n                <thead>\r\n                    <tr>";
            if (mconfig("rankings_show_place_number")) {
                echo "<th>#</th>";
            }
            ...
            if (mconfig("rewards_it")["@attributes"]["weekly"]) {
                $rewardsHtml = $Rankings->returnRewardsHtml("weekly_illusiontemple");
                if ($rewardsHtml != NULL) {
                    echo $rewardsHtml;
                }
            }
        ...
        if (mconfig("rankings_enable_illusiontemple")["@attributes"]["daily"] == "1") {
            ...
            $isActive = "";
            $ranking_data = LoadCacheData("daily_rankings/rankings_illusiontemple.cache");
            echo "\r\n        <div class=\"table-responsive rankings-table\">\r\n            <table class=\"table table-hover text-center\">\r\n                <thead>\r\n                    <tr>";
            if (mconfig("rankings_show_place_number")) {
                echo "<th>#</th>";
            }
            ...
            if (mconfig("rewards_it")["@attributes"]["daily"]) {
                $rewardsHtml = $Rankings->returnRewardsHtml("daily_illusiontemple");
                if ($rewardsHtml != NULL) {
                    echo $rewardsHtml;
                }
            }
    ...
    if (mconfig("active")) {
        ...
        if (mconfig("rankings_enable_illusiontemple")["@attributes"]["general"] == "1") {
            ...
            echo "<th style=\"font-weight:bold;\">" . lang("rankings_txt_36", true) . "</th>";
            echo "<th style=\"font-weight:bold;\">" . lang("rankings_txt_84", true) . "</th>";
            echo "<th style=\"font-weight:bold;\">" . lang("rankings_txt_38", true) . "</th>";
            echo "<th style=\"font-weight:bold;\">" . lang("rankings_txt_46", true) . "</th>";
            if ($config["flags"]) {
            ...
            foreach ($ranking_data as $rdata) {
                if (1 <= $i) {
                    ...
                    echo "<td>" . number_format($rdata[2]) . "</td>";
                    if ($config["flags"]) {
                        echo "<td><img src=\"" . __PATH_TEMPLATE__ . "style/images/blank.png\" class=\"flag-icon flag-icon-" . $rdata[5] . "\" alt=\"" . $custom["countries"][$rdata[5]] . "\" title=\"" . $custom["countries"][$rdata[5]] . "\" /></td>";
                    }
                    echo "</tr>";
                }
                $i++;
