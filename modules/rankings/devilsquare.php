...
if (defined(__RESPONSIVE__) && __RESPONSIVE__ == "TRUE") {
    ...
    if (mconfig("active")) {
        ...
        if ($showTabs) {
            ...
            $isExpanded = "true";
            $count = 0;
            if (mconfig("rankings_enable_devilsquare")["@attributes"]["general"] == "1") {
                $count++;
            ...
            if (mconfig("rankings_enable_devilsquare")["@attributes"]["monthly"] == "1") {
                $count++;
                if ($count == 2) {
                    $isActive = "next";
                }
            ...
            if (mconfig("rankings_enable_devilsquare")["@attributes"]["weekly"] == "1") {
                $count++;
                if ($count == 2) {
                    $isActive = "next";
                }
            ...
            if (mconfig("rankings_enable_devilsquare")["@attributes"]["daily"] == "1") {
                $count++;
                if ($count == 2) {
                    $isActive = "next";
                }
        ...
        if (mconfig("rankings_enable_devilsquare")["@attributes"]["monthly"] == "1") {
            ...
            $isActive = "";
            $ranking_data = LoadCacheData("monthly_rankings/rankings_devilsquare.cache");
            echo "\r\n        <div class=\"table-responsive rankings-table\">\r\n            <table class=\"table table-hover text-center\">\r\n                <thead>\r\n                    <tr>";
            if (mconfig("rankings_show_place_number")) {
                echo "<th>#</th>";
            }
            ...
            if (mconfig("rewards_ds")["@attributes"]["monthly"]) {
                $rewardsHtml = $Rankings->returnRewardsHtml("monthly_devilsquare");
                if ($rewardsHtml != NULL) {
                    echo $rewardsHtml;
                }
            }
        ...
        if (mconfig("rankings_enable_devilsquare")["@attributes"]["weekly"] == "1") {
            ...
            $isActive = "";
            $ranking_data = LoadCacheData("weekly_rankings/rankings_devilsquare.cache");
            echo "\r\n        <div class=\"table-responsive rankings-table\">\r\n            <table class=\"table table-hover text-center\">\r\n                <thead>\r\n                    <tr>";
            if (mconfig("rankings_show_place_number")) {
                echo "<th>#</th>";
            }
            ...
            if (mconfig("rewards_ds")["@attributes"]["weekly"]) {
                $rewardsHtml = $Rankings->returnRewardsHtml("weekly_devilsquare");
                if ($rewardsHtml != NULL) {
                    echo $rewardsHtml;
                }
            }
        ...
        if (mconfig("rankings_enable_devilsquare")["@attributes"]["daily"] == "1") {
            ...
            $isActive = "";
            $ranking_data = LoadCacheData("daily_rankings/rankings_devilsquare.cache");
            echo "\r\n        <div class=\"table-responsive rankings-table\">\r\n            <table class=\"table table-hover text-center\">\r\n                <thead>\r\n                    <tr>";
            if (mconfig("rankings_show_place_number")) {
                echo "<th>#</th>";
            }
            ...
            if (mconfig("rewards_ds")["@attributes"]["daily"]) {
                $rewardsHtml = $Rankings->returnRewardsHtml("daily_devilsquare");
                if ($rewardsHtml != NULL) {
                    echo $rewardsHtml;
                }
            }
    ...
    if (mconfig("active")) {
        ...
        if (mconfig("rankings_enable_devilsquare")["@attributes"]["general"] == "1") {
            ...
            echo "<th style=\"font-weight:bold;\">" . lang("rankings_txt_34", true) . "</th>";
            if ($config["flags"]) {
            ...
            foreach ($ranking_data as $rdata) {
                if (1 <= $i) {
                    ...
                    echo "<td>" . number_format($rdata[2]) . "</td>";
                    if ($config["flags"]) {
                        echo "<td><img src=\"" . __PATH_TEMPLATE__ . "style/images/blank.png\" class=\"flag-icon flag-icon-" . $rdata[3] . "\" alt=\"" . $custom["countries"][$rdata[3]] . "\" title=\"" . $custom["countries"][$rdata[3]] . "\" /></td>";
                    }
                    echo "</tr>";
                }
                $i++;
