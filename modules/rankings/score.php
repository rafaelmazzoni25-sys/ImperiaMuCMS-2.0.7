...
if (defined(__RESPONSIVE__) && __RESPONSIVE__ == "TRUE") {
    ...
    if (mconfig("active") && mconfig("rankings_enable_score")["@attributes"]["general"]) {
        $ranking_data = LoadCacheData("rankings_score.cache");
        ...
        echo "<th>" . lang("rankings_txt_68", true) . "</th>";
        if ($config["flags"]) {
        ...
        foreach ($ranking_data as $rdata) {
            ...
            if (1 <= $i) {
                ...
                echo "<td>" . number_format($rdata[7], 2) . "</td>";
                if ($config["flags"]) {
    ...
    if (mconfig("active") && mconfig("rankings_enable_score")["@attributes"]["general"]) {
        echo lang("rankings_txt_69", true);
        $ranking_data = LoadCacheData("rankings_score.cache");
