...
if (defined(__RESPONSIVE__) && __RESPONSIVE__ == "TRUE") {
    ...
    if (mconfig("active") && mconfig("rankings_enable_achievements")["@attributes"]["general"]) {
        $ranking_data = LoadCacheData("rankings_achievements.cache");
        echo "\r\n        <div class=\"table-responsive rankings-table\">\r\n            <table class=\"table table-hover text-center\">\r\n                <thead>\r\n                    <tr>";
        if (mconfig("rankings_show_place_number")) {
            echo "<th>#</th>";
        }
        echo "\r\n                        <th>" . lang("rankings_txt_10", true) . "</th>\r\n                        <th>" . lang("rankings_txt_11", true) . "</th>\r\n                        <th>" . lang("rankings_txt_33", true) . "</th>\r\n                        <th>" . lang("rankings_txt_34", true) . "</th>";
        if ($config["flags"]) {
    ...
    if (mconfig("active") && mconfig("rankings_enable_achievements")["@attributes"]["general"]) {
        ...
        echo "<th style=\"font-weight:bold;\">" . lang("rankings_txt_33", true) . "</th>";
