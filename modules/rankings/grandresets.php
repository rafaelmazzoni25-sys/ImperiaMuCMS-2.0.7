...
if (defined(__RESPONSIVE__) && __RESPONSIVE__ == "TRUE") {
    ...
    if (mconfig("active")) {
        ...
        if ($showTabs) {
            ...
            $isExpanded = "true";
            $count = 0;
            if (mconfig("rankings_enable_gr")["@attributes"]["general"] == "1") {
                $count++;
            ...
            if (mconfig("rankings_enable_gr")["@attributes"]["monthly"] == "1") {
                $count++;
                if ($count == 2) {
                    $isActive = "next";
                }
            ...
            if (mconfig("rankings_enable_gr")["@attributes"]["weekly"] == "1") {
                $count++;
                if ($count == 2) {
                    $isActive = "next";
                }
            ...
            if (mconfig("rankings_enable_gr")["@attributes"]["daily"] == "1") {
                $count++;
                if ($count == 2) {
                    $isActive = "next";
                }
        ...
        if (mconfig("rankings_enable_gr")["@attributes"]["monthly"] == "1") {
            ...
            $isActive = "";
            $ranking_data = LoadCacheData("monthly_rankings/rankings_gr.cache");
            echo "\r\n        <div class=\"table-responsive rankings-table\">\r\n            <table class=\"table table-hover text-center\">\r\n                <thead>\r\n                    <tr>";
            if (mconfig("rankings_show_place_number")) {
                echo "<th>#</th>";
            }
            ...
            if (mconfig("rewards_grandresets")["@attributes"]["monthly"]) {
                $rewardsHtml = $Rankings->returnRewardsHtml("monthly_grandresets");
                if ($rewardsHtml != NULL) {
                    echo $rewardsHtml;
                }
            }
        ...
        if (mconfig("rankings_enable_gr")["@attributes"]["weekly"] == "1") {
            ...
            $isActive = "";
            $ranking_data = LoadCacheData("weekly_rankings/rankings_gr.cache");
            echo "\r\n        <div class=\"table-responsive rankings-table\">\r\n            <table class=\"table table-hover text-center\">\r\n                <thead>\r\n                    <tr>";
            if (mconfig("rankings_show_place_number")) {
                echo "<th>#</th>";
            }
            ...
            if (mconfig("rewards_grandresets")["@attributes"]["weekly"]) {
                $rewardsHtml = $Rankings->returnRewardsHtml("weekly_grandresets");
                if ($rewardsHtml != NULL) {
                    echo $rewardsHtml;
                }
            }
        ...
        if (mconfig("rankings_enable_gr")["@attributes"]["daily"] == "1") {
            ...
            $isActive = "";
            $ranking_data = LoadCacheData("daily_rankings/rankings_gr.cache");
            echo "\r\n        <div class=\"table-responsive rankings-table\">\r\n            <table class=\"table table-hover text-center\">\r\n                <thead>\r\n                    <tr>";
            if (mconfig("rankings_show_place_number")) {
                echo "<th>#</th>";
            }
            ...
            if (mconfig("rewards_grandresets")["@attributes"]["daily"]) {
                $rewardsHtml = $Rankings->returnRewardsHtml("daily_grandresets");
                if ($rewardsHtml != NULL) {
                    echo $rewardsHtml;
                }
            }
    ...
    if (mconfig("active")) {
        ...
        if (mconfig("rankings_enable_gr")["@attributes"]["general"] == "1") {
            ...
            echo "<th style=\"font-weight:bold;\">" . lang("rankings_txt_21", true) . "</th>";
            if ($config["flags"]) {
