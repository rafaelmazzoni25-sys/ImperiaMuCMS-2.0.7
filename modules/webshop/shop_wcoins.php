            ...
            if ($cat != "1" && $cat != "2" && $cat != "3" && $cat != "4" && $cat != "5" && $cat != "6" && $cat != "7") {
                ...
                if (check_value($_GET["sub"])) {
                    ...
                    if (check_value($_GET["buy"])) {
                        ...
                        if ($itype == "normal") {
                            if (isset($_POST["buy"])) {
                                ...
                                if ($is_socket && !mconfig("allow_same_socket")) {
                                    if (($socket1 < 254 || 255 < $socket1) && ($socket1 == $socket2 || $socket1 == $socket3 || $socket1 == $socket4 || $socket1 == $socket5)) {
                                        $error = true;
                                        $reason = lang("webshop_txt_49", true);
                                    }
                                    if (($socket2 < 254 || 255 < $socket2) && ($socket2 == $socket1 || $socket2 == $socket3 || $socket2 == $socket4 || $socket2 == $socket5)) {
                                        $error = true;
                                        $reason = lang("webshop_txt_49", true);
                                    }
                                    if (($socket3 < 254 || 255 < $socket3) && ($socket3 == $socket1 || $socket3 == $socket2 || $socket3 == $socket4 || $socket3 == $socket5)) {
                                        $error = true;
                                        $reason = lang("webshop_txt_49", true);
                                    }
                                    if (($socket4 < 254 || 255 < $socket4) && ($socket4 == $socket1 || $socket4 == $socket2 || $socket4 == $socket3 || $socket4 == $socket5)) {
                                        $error = true;
                                        $reason = lang("webshop_txt_49", true);
                                    }
                                    if (($socket5 < 254 || 255 < $socket5) && ($socket5 == $socket1 || $socket5 == $socket2 || $socket5 == $socket3 || $socket5 == $socket4)) {
                                        $error = true;
                                        $reason = lang("webshop_txt_49", true);
                                    }
                                }
                                ...
                                if (!$error) {
                                    ...
                                    if ($itemData["item_cat"] == 12 && 200 <= $itemData["item_id"] && $itemData["item_id"] <= 214) {
                                        $dur = 5;
                                    }
                                    ...
                                    switch ($paymentType) {
                                        ...
                                        default:
                                            ...
                                            if (0 < $paymentType) {
                                                switch ($paymentType) {
                                                    case "1":
                                                        $total_price = $total_price * mconfig("price_wcoinc");
                                                        if (100 <= config("server_files_season", true)) {
                                                            $queryCheck = "SELECT TOP 1 WCoin FROM T_InGameShop_Point WHERE AccountID = ?";
                                                            $currencyName2 = "WCoin";
                                                        } else {
                                                            $queryCheck = "SELECT TOP 1 WCoinC FROM T_InGameShop_Point WHERE AccountID = ?";
                                                            $currencyName2 = "WCoinC";
                                                        }
                                                        $currencyName = lang("currency_wcoinc", true);
                                                        break;
                                                    case "2":
                                                        $total_price = $total_price * mconfig("price_wcoinp");
                                                        $queryCheck = "SELECT TOP 1 WCoinP FROM T_InGameShop_Point WHERE AccountID = ?";
                                                        $currencyName = lang("currency_wcoinp", true);
                                                        $currencyName2 = "WCoinP";
                                                        break;
                                                    case "4":
                                                        $total_price = $total_price * mconfig("price_gp");
                                                        $queryCheck = "SELECT TOP 1 GoblinPoint FROM T_InGameShop_Point WHERE AccountID = ?";
                                                        $currencyName = lang("currency_gp", true);
                                                        $currencyName2 = "GoblinPoint";
                                                        break;
                                                }
                                            }
                                ...
                                if (isset($_POST["gift"]) && mconfig("is_gift")) {
                                    ...
                                    $silver = false;
                                    if ($payments["wcoinc"]) {
                                        echo "<a class=\"btn_type4 on\" id=\"btnPlatinum\">" . lang("currency_wcoinc", true) . " <p>" . lang("webshop_txt_57", true) . "</p></a>";
                                        $platinum = true;
                                    }
                                    if ($payments["wcoinp"] && !$platinum) {
                                        echo "<a class=\"btn_type4 on\" id=\"btnGold\">" . lang("currency_wcoinp", true) . " <p>" . lang("webshop_txt_58", true) . "</p></a>";
                                        $gold = true;
                                    } else {
                                        if ($payments["wcoinp"]) {
                                            echo "<a class=\"btn_type4\" id=\"btnGold\">" . lang("currency_wcoinp", true) . " <p>" . lang("webshop_txt_58", true) . "</p></a>";
                                            $gold = true;
                                        }
                                    }
                                    if ($payments["gp"] && !$platinum && !$gold) {
                                        echo "<a class=\"btn_type4 on\" id=\"btnSilver\">" . lang("currency_gp", true) . " <p>" . lang("webshop_txt_59", true) . "</p></a>";
                                    } else {
                                        if ($payments["gp"]) {
                                            echo "<a class=\"btn_type4\" id=\"btnSilver\">" . lang("currency_gp", true) . " <p>" . lang("webshop_txt_59", true) . "</p></a>";
                                        }
                                    }
                                    ...
                                    if ($sub == 33 && $itemData["item_cat"] == 12 && 200 <= $itemData["item_id"] && $itemData["item_id"] <= 214) {
                                        ...
                                        switch ($paymentType) {
                                            ...
                                            default:
                                                ...
                                                if (0 < $paymentType) {
                                                    switch ($paymentType) {
                                                        case "1":
                                                            $packageData["price"] = $packageData["price"] * mconfig("price_wcoinc");
                                                            if (100 <= config("server_files_season", true)) {
                                                                $queryCheck = "SELECT TOP 1 WCoin FROM T_InGameShop_Point WHERE AccountID = ?";
                                                                $currencyName = "WCoin";
                                                            } else {
                                                            ...
                                                            $currencyName2 = lang("currency_wcoinc", true);
                                                            break;
                                                        case "2":
                                                            $packageData["price"] = $packageData["price"] * mconfig("price_wcoinp");
                                                            $queryCheck = "SELECT TOP 1 WCoinP FROM T_InGameShop_Point WHERE AccountID = ?";
                                                            $currencyName = "WCoinP";
                                                            $currencyName2 = lang("currency_wcoinp", true);
                                                            break;
                                                        case "4":
                                                            $packageData["price"] = $packageData["price"] * mconfig("price_gp");
                                                            $queryCheck = "SELECT TOP 1 GoblinPoint FROM T_InGameShop_Point WHERE AccountID = ?";
                                                            $currencyName = "GoblinPoint";
                                                            $currencyName2 = lang("currency_gp", true);
                                                            break;
                                                    }
                                                }
                                                $array = [$_SESSION["username"]];
                                                ...
                                                if ($currencyCheck[$currencyName] < $packageData["price"]) {
                                                    ...
                                                    switch ($paymentType) {
                                                        case "1":
                                                            if (100 <= config("server_files_season", true)) {
                                                                $deduct = $dB->query("UPDATE T_InGameShop_Point SET WCoin = WCoin - ? WHERE AccountID = ?", [$packageData["price"], $_SESSION["username"]]);
                                                            } else {
                                                                $deduct = $dB->query("UPDATE T_InGameShop_Point SET WCoinC = WCoinC - ? WHERE AccountID = ?", [$packageData["price"], $_SESSION["username"]]);
                                                            }
                                                            break;
                                                        case "2":
                                                            $deduct = $dB->query("UPDATE T_InGameShop_Point SET WCoinP = WCoinP - ? WHERE AccountID = ?", [$packageData["price"], $_SESSION["username"]]);
                                                            break;
                                                        case "4":
                                                            $deduct = $dB->query("UPDATE T_InGameShop_Point SET GoblinPoint = GoblinPoint - ? WHERE AccountID = ?", [$packageData["price"], $_SESSION["username"]]);
                                            ...
                                            switch ($paymentType) {
                                                ...
                                                default:
                                                    ...
                                                    if (0 < $paymentType) {
                                                        switch ($paymentType) {
                                                            case "1":
                                                                $mysteryData["price"] = $mysteryData["price"] * mconfig("price_wcoinc");
                                                                if (100 <= config("server_files_season", true)) {
                                                                    $queryCheck = "SELECT TOP 1 WCoin FROM T_InGameShop_Point WHERE AccountID = ?";
                                                                    $currencyName = "WCoin";
                                                                } else {
                                                                ...
                                                                break;
                                                            case "2":
                                                                $mysteryData["price"] = $mysteryData["price"] * mconfig("price_wcoinp");
                                                                $queryCheck = "SELECT TOP 1 WCoinP FROM T_InGameShop_Point WHERE AccountID = ?";
                                                                $currencyName = "WCoinP";
                                                                $currencyName2 = lang("currency_wcoinp", true);
                                                                break;
                                                            case "4":
                                                                $mysteryData["price"] = $mysteryData["price"] * mconfig("price_gp");
                                                                $queryCheck = "SELECT TOP 1 GoblinPoint FROM T_InGameShop_Point WHERE AccountID = ?";
                                                                $currencyName = "GoblinPoint";
                                                                $currencyName2 = lang("currency_gp", true);
                                                                break;
                                                                ...
                                                                foreach ($mysteryItems as $thisItem) {
                                                                    if ($i == $random) {
                                                                        ...
                                                                        switch ($paymentType) {
                                                                            case "1":
                                                                                if (100 <= config("server_files_season", true)) {
                                                                                    $deduct = $dB->query("UPDATE T_InGameShop_Point SET WCoin = WCoin - ? WHERE AccountID = ?", [$mysteryData["price"], $_SESSION["username"]]);
                                                                                } else {
                                                                                    $deduct = $dB->query("UPDATE T_InGameShop_Point SET WCoinC = WCoinC - ? WHERE AccountID = ?", [$mysteryData["price"], $_SESSION["username"]]);
                                                                                }
                                                                                break;
                                                                            case "2":
                                                                                $deduct = $dB->query("UPDATE T_InGameShop_Point SET WCoinP = WCoinP - ? WHERE AccountID = ?", [$mysteryData["price"], $_SESSION["username"]]);
                                                                                break;
                                                                            case "4":
                                                                                $deduct = $dB->query("UPDATE T_InGameShop_Point SET GoblinPoint = GoblinPoint - ? WHERE AccountID = ?", [$mysteryData["price"], $_SESSION["username"]]);
                        ...
                        if (mconfig("show_wcoinc")) {
                            echo "\r\n              <label class=\"label_check\">\r\n                <div></div>\r\n                <input type=\"checkbox\" class=\"chItemPrice\" id=\"chShowPlatinum\" checked=\"checked\">\r\n                <p><font color=\"#00ffa8\">" . lang("currency_wcoinc", true) . "</font></p>\r\n              </label>";
                        }
                        if (mconfig("show_wcoinp")) {
                            echo "\r\n              <label class=\"label_check\">\r\n                <div></div>\r\n                <input type=\"checkbox\" class=\"chItemPrice\" id=\"chShowGold\">\r\n                <p><font color=\"#b38e47\">" . lang("currency_wcoinp", true) . "</font></p>\r\n              </label>";
                        }
                        if (mconfig("show_gp")) {
                            echo "\r\n              <label class=\"label_check\">\r\n                <div></div>\r\n                <input type=\"checkbox\" class=\"chItemPrice\" id=\"chShowSilver\" checked=\"checked\">\r\n                <p><font color=\"#959595\">" . lang("currency_gp", true) . "</font></p>\r\n              </label>";
                        }
                        echo "\r\n\t\t        </dd>\r\n\t        </dl>\r\n        </div>";
                        if ($cat == "1" && $sub == "30") {
                            ...
                            if (0 < count($items)) {
                                foreach ($items as $thisItem) {
                                    ...
                                    echo "</span>\r\n                          <div class=\"itemcost\">\r\n                            <div class=\"itemPricePlatinum\"><span class=\"itemPrice\"><font color=\"#00ffa8\">" . ceil($thisItem["price"] * mconfig("price_wcoinc")) . "</font></span>&nbsp;" . lang("currency_wcoinc", true) . "<br /></div>\r\n                            <div class=\"itemPriceGold\"><span class=\"itemPrice\"><font color=\"#b38e47\">" . ceil($thisItem["price"] * mconfig("price_wcoinp")) . "</font></span>&nbsp;" . lang("currency_wcoinp", true) . "<br /></div>\r\n                            <div class=\"itemPriceSilver\"><span class=\"itemPrice\"><font color=\"#959595\">" . ceil($thisItem["price"] * mconfig("price_gp")) . "</font></span>&nbsp;" . lang("currency_gp", true) . "<br /></div>\r\n                          </div>\r\n                        </dd>\r\n                      </dl>\r\n                    </div>\r\n                    </a>";
                                }
                            } else {
