    ...
    try {
        ...
        if (is_array($searchResults)) {
            ...
            foreach ($searchResults as $character) {
                ...
                echo "<a href=\"" . gmcp_base("accountinfo&id=" . $common->retrieveUserID($character["AccountID"])) . "\" class=\"btn btn-xs btn-default\">Account Information</a> ";
                echo "<a href=\"" . gmcp_base("editcharacter&name=" . hex_encode($character["Name"])) . "\" class=\"btn btn-xs btn-warning\">Edit Character</a>";
                echo "</td></tr>";
            }
