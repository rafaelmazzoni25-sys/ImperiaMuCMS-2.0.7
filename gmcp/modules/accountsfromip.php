    ...
    try {
        ...
        if (is_array($membStatData)) {
            ...
            foreach ($membStatData as $membStatUser) {
                ...
                echo "<td style=\"text-align:right;\"><a href=\"" . gmcp_base("accountinfo&id=" . $common->retrieveUserID($membStatUser[_CLMN_MS_MEMBID_])) . "\" class=\"btn btn-xs btn-default\">Account Information</a></td>";
                echo "</tr>";
            }
            echo "</table>";
        } else {
