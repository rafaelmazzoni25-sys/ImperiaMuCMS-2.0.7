...
class NL_MicroCheckout
{
    ...
    private $tokenCode = "";
    public function __construct($merchant_site_code, $merchant_password, $url_ws)
    {
    ...
    {
        $params = ["merchant_site_code" => $this->merchantSiteCode, "checksum" => $this->_makeChecksum($inputs), "params" => "<params>" . $this->_convertArrayToXML($inputs) . "</params>"];
    ...
    {
        return ["receiver", "order_code", "amount", "currency_code", "tax_amount", "discount_amount", "fee_shipping", "request_confirm_shipping", "no_shipping", "return_url", "cancel_url", "language", "token"];
    }
