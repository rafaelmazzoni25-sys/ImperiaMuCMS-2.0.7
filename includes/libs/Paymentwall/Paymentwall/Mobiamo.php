...
class Paymentwall_Mobiamo extends Paymentwall_ApiObject
{
    ...
    {
        $defaultParams = ["key" => $this->getConfig()->getPublicKey(), "ts" => time(), "sign_version" => Paymentwall_Signature_Abstract::VERSION_TWO];
    ...
    {
        if ($this->getEndpointName() === API_OBJECT_ONE_TIME_TOKEN && !$this->getConfig()->isTest()) {
