...
echo "    <h1 class=\"page-header\">Votes</h1>\r\n";
$logs = $dB->query_fetch("SELECT * FROM IMPERIAMUCMS_VOTES WHERE confirm = 1 ORDER BY id DESC");
if (is_array($logs)) {
    echo "<table id=\"webshop_logs\" class=\"table display\"><thead><tr><th>Date</th><th>AccountID</th><th>Vote Site</th><th>IP</th></tr></thead><tbody>";
