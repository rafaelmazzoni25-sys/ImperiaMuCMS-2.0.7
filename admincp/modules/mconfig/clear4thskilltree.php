...
echo "<h2>Clear 4th Skill-Tree Settings</h2>\r\n";
if (check_value($_POST["submit_changes"])) {
    savechanges();
}
loadModuleConfigs("usercp.clear4thskilltree");
echo "<form action=\"\" method=\"post\">\r\n    <table class=\"table table-striped table-bordered table-hover module_config_tables\">\r\n        <tr>\r\n            <th>Status<br/><span>Enable/disable the clear 4th skill-tree module.</span></th>\r\n            <td>\r\n                ";
enabledisableCheckboxes("setting_1", mconfig("active"), "Enabled", "Disabled");
echo "            </td>\r\n        </tr>\r\n        <tr>\r\n            <th>Price Requirement<br/></th>\r\n            <td>\r\n                ";
enabledisableCheckboxes("setting_2", mconfig("enable_requirement"), "Enabled", "Disabled");
...
function saveChanges()
{
    ...
    $xmlPath = __PATH_MODULE_CONFIGS__ . "usercp.clear4thskilltree.xml";
    $xml = simplexml_load_file($xmlPath);
    $xml->active = $_POST["setting_1"];
    $xml->enable_requirement = $_POST["setting_2"];
    $xml->price_type = $_POST["setting_5"];
    $xml->price = $_POST["setting_3"];
    $xml->required_level = $_POST["setting_4"];
