...
echo "    <h2>Dual Skill Tree Settings</h2>\r\n";
...
if (check_value($_POST["activate_module"])) {
    ...
    $General->jIhfnHDm_activate_KdiupmNBd_Module("dualskilltree", $key);
}
$isActivated = $General->jHdksHgYYix_isModule_hDbMVOIfs_Activated("dualskilltree");
if (!$isActivated) {
    ...
    loadModuleConfigs("usercp.dualskilltree");
    $creditSystem = new CreditSystem($common, new Character(), $dB, $dB2);
    echo "    <form action=\"\" method=\"post\">\r\n        <table class=\"table table-striped table-bordered table-hover module_config_tables\">\r\n            <tr>\r\n                <th>Status<br/><span>Enable/disable the dual skill tree module.</span></th>\r\n                <td>\r\n                    ";
    ...
    echo "\"/>\r\n                </td>\r\n            </tr>\r\n            <tr>\r\n                <th>Is Locked<br/><span>Yes = player will have to pay required amount to unlock Dual Skill Tree module<br>No = usage is free</span></th>\r\n                <td>\r\n                    ";
...
function saveChanges()
{
    ...
    $xmlPath = __PATH_MODULE_CONFIGS__ . "usercp.dualskilltree.xml";
