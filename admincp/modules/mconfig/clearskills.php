...
echo "<h2>Clear Skills Settings</h2>\r\n";
if (check_value($_POST["submit_changes"])) {
    savechanges();
}
loadModuleConfigs("usercp.clearskills");
echo "<form action=\"\" method=\"post\">\r\n    <table class=\"table table-striped table-bordered table-hover module_config_tables\">\r\n        <tr>\r\n            <th>Status<br/><span>Enable/disable the clear skills module.</span></th>\r\n            <td>\r\n                ";
enabledisableCheckboxes("setting_1", mconfig("active"), "Enabled", "Disabled");
echo "            </td>\r\n        </tr>\r\n        <tr>\r\n            <th>Price Requirement<br/></th>\r\n            <td>\r\n                ";
enabledisableCheckboxes("setting_2", mconfig("clearskills_enable_requirement"), "Enabled", "Disabled");
...
echo mconfig("clearskills_price");
echo "\"/>\r\n            </td>\r\n        </tr>\r\n        <tr>\r\n            <th>Required Level<br/><span>Required Level to clear Skills.</span></th>\r\n            <td>\r\n                <input class=\"form-control\" type=\"text\" name=\"setting_4\"\r\n                       value=\"";
echo mconfig("clearskills_required_level");
...
function saveChanges()
{
    ...
    $xmlPath = __PATH_MODULE_CONFIGS__ . "usercp.clearskills.xml";
    $xml = simplexml_load_file($xmlPath);
    $xml->active = $_POST["setting_1"];
    $xml->clearskills_enable_requirement = $_POST["setting_2"];
    $xml->clearskills_price_type = $_POST["setting_5"];
    $xml->clearskills_price = $_POST["setting_3"];
    $xml->clearskills_required_level = $_POST["setting_4"];
