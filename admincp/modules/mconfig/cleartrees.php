...
echo "<h2>Clear Trees Settings</h2>\r\n";
if (check_value($_POST["submit_changes"])) {
    savechanges();
}
loadModuleConfigs("usercp.cleartrees");
echo "<form action=\"\" method=\"post\">\r\n    <table class=\"table table-striped table-bordered table-hover module_config_tables\">\r\n        <tr>\r\n            <th>Status<br/><span>Enable/disable the clear trees module.</span></th>\r\n            <td>\r\n                ";
...
function saveChanges()
{
    ...
    $xmlPath = __PATH_MODULE_CONFIGS__ . "usercp.cleartrees.xml";
