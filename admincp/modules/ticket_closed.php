...
if (isset($_GET["id"])) {
    ...
    if (isset($_GET["change"])) {
        ...
        echo "<div><a href=\"index.php?module=ticket_closed\" class=\"btn\">Back to Closed Tickets</a></div>";
        message("success", "Status of Ticket #" . $ticket_id . " was changed to " . $newstatus . "");
    }
    $Ticket = new Ticket();
    $thisTicket = $Ticket->getTicketById($ticket_id);
    if (check_value($_POST["submit"])) {
        $checkSubmit = $Ticket->SubmitReply($ticket_id, $_POST["message"], mconfig("staff_nickname"));
    }
    ...
    echo "\r\n  <table class=\"table table-striped table-bordered table-hover\">\r\n  \t<tr>\r\n    \t<th>Subject</th>\r\n      <td>" . stripslashes($thisTicket["subject"]) . "</td>\r\n  \t</tr>\r\n    <tr>\r\n    \t<th>Author</th>\r\n      <td>" . $thisTicket["author"] . "</td>\r\n  \t</tr>\r\n    <tr>\r\n    \t<th>Create Date</th>\r\n      <td>" . $date . "</td>\r\n  \t</tr>\r\n    <tr>\r\n    \t<th>Status</th>\r\n      <td>" . $thisTicket["status"] . "\r\n        <div class=\"btn-group\">\r\n          <a class=\"btn dropdown-toggle btn\" data-toggle=\"dropdown\" href=\"#\">Change Status<span class=\"caret\"></span></a>\r\n          <ul class=\"dropdown-menu\">\r\n            <li><a href=\"index.php?module=ticket_closed&id=" . $ticket_id . "&change=open\"><span class=\"ticket-open\">Opened</span></a></li>\r\n            <li><a href=\"index.php?module=ticket_closed&id=" . $ticket_id . "&change=wait\"><span class=\"ticket-wait\">Waiting</span></a></li>\r\n            <li><a href=\"index.php?module=ticket_closed&id=" . $ticket_id . "&change=close\"><span class=\"ticket-closed\">Closed</span></a></li>\r\n          </ul>\r\n        </div>\r\n      </td>\r\n  \t</tr>\r\n  </table>";
    $date = date($config["time_date_format"], strtotime($thisTicket["date"]));
    echo "\r\n  <table class=\"table2 table-striped table-bordered table-hover\">\r\n  \t<tr>\r\n    \t<th width=\"50%\">" . $thisTicket["author"] . ":</th>\r\n      <td width=\"50%\" align=\"right\">" . $date . "</td>\r\n  \t</tr>\r\n    <tr>\r\n      <td colspan=\"2\">" . stripslashes($thisTicket["message"]) . "</td>\r\n  \t</tr>\r\n  </table>";
    ...
    echo "\r\n  <form action=\"\" method=\"post\">\r\n    <table class=\"table3\">\r\n      <tr>\r\n        <td><textarea class=\"form-control\" rows=\"6\" name=\"message\" pattern=\".{" . $minlength1 . "," . $maxlength1 . "}\" required title=\"Enter " . $minlength1 . " - " . $maxlength1 . " characters\"></textarea></td>\r\n      </tr>\r\n      <tr>\r\n        <td align=\"right\"><input type=\"submit\" name=\"submit\" value=\"Submit Reply\" class=\"btn btn-primary\"/></td>\r\n      </tr>\r\n    </table>\r\n  </form>\r\n  ";
} else {
    echo "<h2>Ticket System: Closed Tickets</h2>";
    $getClosedTickets = $dB->query_fetch("SELECT * FROM IMPERIAMUCMS_TICKETS WHERE status = 1 ORDER BY date asc");
    if (is_array($getClosedTickets)) {
        message("", count($getClosedTickets), "Total Closed Tickets:");
        echo "<table class=\"table table-striped table-bordered table-hover\">\r\n  \t<tr>\r\n  \t<th width=\"1%\">ID</th>\r\n  \t<th width=\"20%\">Subject</th>\r\n  \t<th width=\"10%\">Author</th>\r\n    <th width=\"20%\">Create Date</th>\r\n    <th width=\"20%\">Last Update</th>\r\n    <th width=\"10%\">Last Update By</th>\r\n    <th width=\"5%\">Status</th>\r\n    <th width=\"5%\">Action</th>\r\n  \t</tr>";
        foreach ($getClosedTickets as $thisTicket) {
            $date = date($config["time_date_format"], strtotime($thisTicket["date"]));
            ...
            echo "<td><a href=\"index.php?module=ticket_closed&id=" . $thisTicket["ticket_id"] . "\" class=\"btn\">View</a></td>";
            echo "</tr>";
        }
        echo "\r\n  \t</table>";
    } else {
        message("error", "Closed tickets was not found.");
    }
}
