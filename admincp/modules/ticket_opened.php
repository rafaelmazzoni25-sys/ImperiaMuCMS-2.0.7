...
if (isset($_GET["id"])) {
    ...
    echo "\r\n  <form action=\"\" method=\"post\">\r\n    <table class=\"table3\" width=\"100%\">\r\n      <tr>\r\n        <td><textarea class=\"form-control\" style=\"width:100%\" rows=\"6\" name=\"message\" pattern=\".{" . $minlength1 . "," . $maxlength1 . "}\" required title=\"Enter " . $minlength1 . " - " . $maxlength1 . " characters\"></textarea></td>\r\n      </tr>\r\n      <tr>\r\n        <td align=\"right\"><input type=\"submit\" name=\"submit\" value=\"Submit Reply\" class=\"btn btn-primary\"/></td>\r\n      </tr>\r\n    </table>\r\n  </form>\r\n  ";
} else {
