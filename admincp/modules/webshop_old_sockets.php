...
if (check_value($_POST["submit"])) {
    ...
    if (is_array($items_list)) {
        ...
        foreach ($items_list as $thisItem) {
            ...
            echo "<td>";
            echo "<a class=\"btn btn-default btn-sm\" href=\"" . admincp_base("webshop_old_sockets_edit&id=" . $thisItem["id"]) . "\"><i class=\"fa fa-edit\"></i> Edit</a> ";
            if ($thisItem["active"] == 0) {
                echo "<a class=\"btn btn-success btn-sm\" href=\"" . admincp_base("webshop_old_sockets&enable=" . $thisItem["id"]) . "\"><i class=\"fa fa-check-circle\"></i> Enable</a>";
            } else {
                echo "<a class=\"btn btn-danger btn-sm\" href=\"" . admincp_base("webshop_old_sockets&disable=" . $thisItem["id"]) . "\"><i class=\"fa fa-times-circle\"></i> Disable</a>";
            }
            echo "</td></tr>";
            $i++;
        }
