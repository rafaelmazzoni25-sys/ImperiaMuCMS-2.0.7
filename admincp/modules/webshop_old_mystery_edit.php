...
if (check_value($_POST["edit_mystery"])) {
    $Webshop->editMystery($_REQUEST["id"], $_POST["setting_1"], $_POST["setting_2"], $_POST["setting_3"], $_POST["setting_4"], $_POST["setting_5"], $_POST["setting_6"], $_POST["setting_7"], $_POST["setting_8"]);
