...
if (check_value($_POST["submit"])) {
    ...
    if (is_array($items_list)) {
        ...
        foreach ($items_list as $thisItem) {
            ...
            echo "<td>";
            echo "<a class=\"btn btn-default btn-sm\" href=\"" . admincp_base("webshop_old_harmony_edit&id=" . $thisItem["id"]) . "\"><i class=\"fa fa-edit\"></i> edit</a> ";
            if ($thisItem["status"] == 0) {
                echo "<a class=\"btn btn-success btn-sm\" href=\"" . admincp_base("webshop_old_harmony&enable=" . $thisItem["id"]) . "\"><i class=\"fa fa-check-circle\"></i> enable</a>";
            } else {
                echo "<a class=\"btn btn-danger btn-sm\" href=\"" . admincp_base("webshop_old_harmony&disable=" . $thisItem["id"]) . "\"><i class=\"fa fa-times-circle\"></i> disable</a>";
            }
            echo "</td></tr>";
            $i++;
        }
