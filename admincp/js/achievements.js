...
function addStage(description, requirements, reward_type, reward, points)
{
    ...
    html += '<p><small><b>Examples:</b><br>MonsterID: "<b>135</b>" Count: "<b>10</b>" = Kill 10x White Wizard<br>MonsterID: "<b>135,275</b>" Count: "<b>10</b>" = Kill 10x White Wizard or Kundun, IDs must be divided by comma WITHOUT spaces (it doesn\'t matter which one, together must be 10, so you can kill 3x Kundun and 7x White Wizard and stage will be completed)<br>MonsterID: "<b>-1</b>" Count: "<b>1000</b>" = Kill 1000x any monsters</small></p>';
    ...
    html += '<td>';
    html += '<select class="form-control" name="'+stageId+'rewardType" id="'+stageId+'_rewardType">';
...
function addItem(divId, itemId, count, category, index, level, skill, luck, option, excellent, ancient)
{
    ...
    html += 'Count: <input class="form-control" style="width:40px; display: inline;" type="text" name="'+divId+'item_count['+itemId+']" id="'+divId+'item_count'+itemId+'" value="'+count+'"/>';
    html += ' Category: <input class="form-control" style="width:40px; display: inline;" type="text" name="'+divId+'item_category['+itemId+']" id="'+divId+'item_category'+itemId+'" value="'+category+'"/>';
    html += ' Index: <input class="form-control" style="width:40px; display: inline;" type="text" name="'+divId+'item_index['+itemId+']" id="'+divId+'item_index'+itemId+'" value="'+index+'"/>';
    html += ' Level: <input class="form-control" style="width:40px; display: inline;" type="text" name="'+divId+'item_level['+itemId+']" id="'+divId+'item_level'+itemId+'" value="'+level+'"/>';
    html += ' Skill: <input class="form-control" style="width:40px; display: inline;" type="text" name="'+divId+'item_skill['+itemId+']" id="'+divId+'item_skill'+itemId+'" value="'+skill+'"/>';
    html += ' Luck: <input class="form-control" style="width:40px; display: inline;" type="text" name="'+divId+'item_luck['+itemId+']" id="'+divId+'item_luck'+itemId+'" value="'+luck+'"/>';
    html += ' Option: <input class="form-control" style="width:40px; display: inline;" type="text" name="'+divId+'item_option['+itemId+']" id="'+divId+'item_option'+itemId+'" value="'+option+'"/>';
    html += ' Excellent: <input class="form-control" style="width:40px; display: inline;" type="text" name="'+divId+'item_excellent['+itemId+']" id="'+divId+'item_excellent'+itemId+'" value="'+excellent+'"/>';
    html += ' Ancient: <input class="form-control" style="width:40px; display: inline;" type="text" name="'+divId+'item_ancient['+itemId+']" id="'+divId+'item_ancient'+itemId+'" value="'+ancient+'"/>';
