var ImperiaMuCMS = {
    init: function (options) {
        ...
        if (null == path) {
            path = "";
            for (var scripts = document.getElementsByTagName("script"), i = 0; i < scripts.length; i++) scripts[i].src && scripts[i].src.match(/imperiamucms[\.?](.*?)\.js/i) && (path = scripts[i].src.substr(0, scripts[i].src.lastIndexOf("/") + 1))
        }
        //this.publicPath = path, this.include("imperiamucms.extension.js");
        var instance = this;
        $("body").on("click", "*", function (event) {
            ...
            if ("undefined" != sender.attr("xw-submit") && ("" === sender.attr("xw-submit") || sender.attr("xw-submit"))) {
                ...
                ImperiaMuCMS.sendForm({sender: sender, form: form, method: method, url: url})
            }
            ...
            if (sender.attr("xw-get")) {
                if (event.preventDefault(event), 0 == instance.checkOperation(sender)) return !1;
                ImperiaMuCMS.sendRequest({sender: sender, method: "GET", url: sender.attr("xw-get")})
            }
            if (sender.attr("xw-post")) {
                if (event.preventDefault(event), 0 == instance.checkOperation(sender)) return !1;
                ImperiaMuCMS.sendRequest({sender: sender, method: "POST", url: sender.attr("xw-post")})
            }
            if (sender.attr("xw-put")) {
                if (event.preventDefault(event), 0 == instance.checkOperation(sender)) return !1;
                ImperiaMuCMS.sendRequest({sender: sender, method: "PUT", url: sender.attr("xw-put")})
            }
            if (sender.attr("xw-delete")) {
                if (event.preventDefault(event), 0 == instance.checkOperation(sender)) return !1;
                ImperiaMuCMS.sendRequest({sender: sender, method: "DELETE", url: sender.attr("xw-delete")})
            }
            if (sender.attr("xw-options")) {
                if (event.preventDefault(event), 0 == instance.checkOperation(sender)) return !1;
                ImperiaMuCMS.sendRequest({sender: sender, method: "OPTIONS", url: sender.attr("xw-options")})
            }
            if (sender.attr("xw-patch")) {
                if (event.preventDefault(event), 0 == instance.checkOperation(sender)) return !1;
                ImperiaMuCMS.sendRequest({sender: sender, method: "PATCH", url: sender.attr("xw-patch")})
            }
    ...
    sendForm: function (e) {
        ...
        return c.append("_METHOD", n), r.find("*").each(function (e, t) {
            ...
            dataType: "json",
            url: o,
            headers: {ImperiaMuCMSRequest: "json"},
            data: c,
            enctype: "multipart/form-data",
            contentType: !1,
            processData: !1,
            beforeSend: function (e) {
                e.setRequestHeader("ImperiaMuCMSRequest", "json"), null != i && i(e)
            },
            success: function (e) {
                return null != a ? a(e) : ImperiaMuCMS.protocol(e)
            },
            error: function (e, t) {
                if (null != s) {
                    if (-1 != e.responseText.search("\ufeff") && -1 != e.responseText.indexOf("[[")) return ImperiaMuCMS.protocol(JSON.parse(e.responseText.replace("\ufeff", "")));
                    s(e, t)
                } else {
                    if (-1 != e.responseText.search("\ufeff") && -1 != e.responseText.indexOf("[[")) return ImperiaMuCMS.protocol(JSON.parse(e.responseText.replace("\ufeff", "")));
                    ImperiaMuCMS.debugStart(e.responseText)
                }
            }
        }).always(function (e) {
    ...
    sendRequest: function (t) {
        ...
        return $.ajax({
            type: "POST", dataType: "json", url: o, data: {_METHOD: n}, async: a, beforeSend: function (e) {
                e.setRequestHeader("ImperiaMuCMSRequest", "json"), null != l && l(e)
            }, success: function (e) {
                return null != s ? s(e) : ImperiaMuCMS.protocol(e)
            }, error: function (e, t) {
                if (null != i) {
                    if (-1 != e.responseText.search("\ufeff") && -1 != e.responseText.indexOf("[[")) return ImperiaMuCMS.protocol(JSON.parse(e.responseText.replace("\ufeff", "")));
                    i(e, t)
    ...
    debugStart: function (e) {
        if (0 != confirm("An exception occurred from the server side.\nDo you want to debug?")) if (console.log(e), this.debugBodyContent = $("body").html(), $("body").html(""), 0 == /<(br|basefont|hr|input|source|frame|param|area|meta|!--|col|link|option|base|img|wbr|!DOCTYPE).*?>|<(a|abbr|acronym|address|applet|article|aside|audio|b|bdi|bdo|big|blockquote|body|button|canvas|caption|center|cite|code|colgroup|command|datalist|dd|del|details|dfn|dialog|dir|div|dl|dt|em|embed|fieldset|figcaption|figure|font|footer|form|frameset|head|header|hgroup|h1|h2|h3|h4|h5|h6|html|i|iframe|ins|kbd|keygen|label|legend|li|map|mark|menu|meter|nav|noframes|noscript|object|ol|optgroup|output|p|pre|progress|q|rp|rt|ruby|s|samp|script|section|select|small|span|strike|strong|style|sub|summary|sup|table|tbody|td|textarea|tfoot|th|thead|time|title|tr|track|tt|u|ul|var|video).*?<\/\2>/i.test(e)) {
            var t = "";
            t += '<table style="font-size: 14px;" border="1" cellspacing="0" cellpadding="1">', t += '<tbody><tr><th align="left" bgcolor="#f57900" colspan="5">', t += '<span style="background-color: #cc0000; color: #fce94f; font-size: x-large;">( ! )</span> Unexpected Error: please contact the web master or administrator</th></tr>', t += '<tr><th align="left" bgcolor="#e9b96e" colspan="5"><b>Message:</b></th></tr>', t += '<tr><th bgcolor="#eeeeec" style="font-weight: 100;">', t += e, t += "</th></tr></tbody></table>", t += '<br><input type="button" onclick="ImperiaMuCMS.debugClose();" value="Close Debug Mode" style="font-size: 14px; color: black;">', $("body").append(t)
        } else $("body").append(e), $("body").append('<br><input type="button" onclick="ImperiaMuCMS.debugClose();" value="Close Debug Mode" style="font-size: 14px; color: black;">')
    },
    debugClose: function () {
