...
echo __PATH_TEMPLATE__;
echo "css/bootstrap.min.css?v=2\" rel=\"stylesheet\">\n    <link href=\"";
echo __PATH_TEMPLATE__;
echo "css/normalize.css\" rel=\"stylesheet\">\n    <link rel=\"stylesheet\" href=\"https://use.fontawesome.com/releases/v5.3.1/css/all.css\">\n    <link rel=\"stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css\">\n    <link href=\"";
echo __PATH_TEMPLATE__;
echo "css/imperiamucms.css?v=61\" rel=\"stylesheet\">\n    <link href=\"";
echo __PATH_TEMPLATE__;
...
if ($config["show_countdown"] && $date < $config["countdown_date"]) {
    if ($templateConfig["countdown_position"] == "center") {
        ...
        if ($templateConfig["countdown_position"] == "left") {
            $countdownPos = "";
        } else {
            if ($templateConfig["countdown_position"] == "right") {
...
echo "            </div>\n            ";
$handler->imperiamucmsPoweredResponsive();
