...
if ($templateConfig['characters_rankings']) {
    ...
    <div class="row">
        <div id="carousel-characters-rankings" class="carousel slide" data-ride="carousel">
            ...
            <!--<a class="left carousel-control" href="#carousel-characters-rankings" role="button" data-slide="prev">
                <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
            </a>
            <a class="right carousel-control" href="#carousel-characters-rankings" role="button" data-slide="next">
